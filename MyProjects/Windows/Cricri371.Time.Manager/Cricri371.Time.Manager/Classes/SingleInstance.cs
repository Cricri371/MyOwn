...
namespace Microsoft.Shell
{
    ...
    internal enum WM
    {
        ...
        // This is the hard-coded message value used by WinForms for Shell_NotifyIcon. It's
        // relatively safe to reuse.
    ...
    internal static class NativeMethods
    {
        ...
        public static string[] CommandLineToArgvW(string cmdLine)
        {
            ...
            finally
            {
                ...
                // Otherwise LocalFree failed. Assert.AreEqual(IntPtr.Zero, p);
            }
        }
    }
                ...
                where TApplication : Application, ISingleInstanceApp
    {
        ...
        public static bool InitializeAsFirstInstance(string uniqueName)
        {
            ...
            // Create mutex based on unique application Id to check if this is the first instance of
            // the application.
            bool firstInstance;
        ...
        private static IList<string> GetCommandLineArgs(string uniqueApplicationName)
        {
            ...
            {
                // The application was not click once deployed, get args from standard API's
                args = Environment.GetCommandLineArgs();
            }
            else
            {
                // The application was click once deployed Click once deployed apps cannot receive
                // traditional command line arguments As a workaround command line arguments can be
                // written to a shared location before the app is launched and the app can obtain its
                // command line arguments from the shared location
        ...
        /// server - in this case, the remoting service exposed by the first instance. Calls a
        /// function of the remoting service class to pass on command line arguments from the second
        /// instance to the first and cause it to activate itself.
        /// </summary>
        /// <param name="channelName"> Application's IPC channel name. </param>
        /// <param name="args">
        ...
        private static void SignalFirstInstance(string channelName, IList<string> args)
        {
            ...
            // Obtain a reference to the remoting service exposed by the server i.e the first
            ...
            // Check that the remote service exists, in some cases the first instance may not yet
            // have created one, in which case the second instance should just exit
        ...
        /// <summary>
        /// Remoting service class which is exposed by the server i.e the first instance and called
        /// by the second instance to pass on the command line arguments to the first instance and
        /// cause it to activate itself.
        /// </summary>
        private class IPCRemoteService : MarshalByRefObject
        {
            ...
            /// <summary>
            /// Remoting Object's ease expires after every 5 minutes by default. We need to override
            /// the InitializeLifetimeService class to ensure that lease never expires.
            /// </summary>
            /// <returns> Always null. </returns>
